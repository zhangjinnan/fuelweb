...
[
    ...
    'views/cluster_page_tabs/redhat_tab',
...
function(utils, models, commonViews, dialogViews, NodesTab, NetworkTab, SettingsTab, LogsTab, ActionsTab, RedHatTab, clusterPageTemplate, deploymentResultTemplate, deploymentControlTemplate) {
    'use strict';
    ...
    ClusterPage = commonViews.Page.extend({
        ...
        tabs: ['nodes', 'network', 'settings', 'logs', 'actions', 'redhat'],
        updateInterval: 5000,
