...
casper.then(function() {
    ...
    this.then(function() {
        this.test.assertSelectorAppears('.btn-revert-changes:disabled', 'Cancel changes button is disabled after changes were saved successfully');
    });
});
...
casper.then(function() {
    ...
    this.waitForSelector('.btn-load-defaults:not(:disabled)');
    this.then(function() {
        this.test.assertSelectorAppears('.btn-revert-changes:not(:disabled)', 'Cancel changes button is enabled after defaults were loaded');
