...
repo --name=openstack-epel-fuel --mirrorlist=http://download.mirantis.com/epel-fuel-folsom/mirror.internal.list --cost=1
...
repo --name=puppetlabs-deps --baseurl=http://yum.puppetlabs.com/el/6/dependencies/x86_64/ --cost=5
